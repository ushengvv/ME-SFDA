...
def train_source(args):
    ...
    for epoch in range(args.max_epoch):
        ...
        if (epoch + 1) % 10 == 0 and epoch + 1 != args.max_epoch:
            torch.save(best_netF, osp.join(args.output_dir_src, "_" + str(epoch + 1) + "_source_F.pt"))
            torch.save(best_netB, osp.join(args.output_dir_src, "_" + str(epoch + 1) + "_source_B.pt"))
            torch.save(best_netC, osp.join(args.output_dir_src, "_" + str(epoch + 1) + "_source_C.pt"))
            print("_____")
